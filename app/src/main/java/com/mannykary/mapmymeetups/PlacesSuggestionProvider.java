...
public class PlacesSuggestionProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.mannykary.mapmymeetups.search_suggestion_provider";
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        } else if (query.length() > 5 && query.length() % 3 == 0) {
            Log.d(LOG_TAG, "query = " + query);
            list = MainActivity.autocomplete(query);
        }
            ...
            case SEARCH_SUGGEST:
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    cursor.addRow(new String[]{
                            Integer.toString(i), p.title, p.subtitle, p.placeId
                    });
                }
                return cursor;
            default:
